...
type TBC20PoolHistoryResponse struct {
	...
	FtLpBalanceChange           string `json:"ft_lp_balance_change"`             // LP代币余额变化
	...
	TokenPairAPoolBalanceChange string `json:"token_pair_a_pool_balance_change"` // 代币A的池子余额变化
	...
	TokenPairBPoolBalanceChange string `json:"token_pair_b_pool_balance_change"` // 代币B的池子余额变化
}
